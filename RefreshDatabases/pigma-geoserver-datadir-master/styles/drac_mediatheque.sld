...
<sld:StyledLayerDescriptor version="1.0.0"
    ...
    <sld:NamedLayer>
        <sld:Name>drac:drac_mediatheques</sld:Name>
        <sld:UserStyle>
            <sld:FeatureTypeStyle>
                <sld:Rule>
                    <sld:Name>Classe_1249</sld:Name>
                    <sld:Title>mediatheque</sld:Title>
                    <sld:PointSymbolizer>
                        <sld:Graphic>
                            <sld:Mark>
                                <sld:WellKnownName>square</sld:WellKnownName>
                                <sld:Fill>
                                    <sld:CssParameter name="fill">#A8AAFF</sld:CssParameter>
