...
<sld:StyledLayerDescriptor version="1.0.0"
    ...
    <sld:NamedLayer>
        <sld:Name>ars:ars_etablissements_adultes_handicapes</sld:Name>
        <sld:UserStyle>
          <sld:FeatureTypeStyle>
        <sld:Rule>
          <sld:Name>Etablissements adultes handicapés</sld:Name>
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:Mark>
                <sld:WellKnownName>cross</sld:WellKnownName>
                <sld:Fill>
                  <sld:CssParameter name="fill">#FFC501</sld:CssParameter>
