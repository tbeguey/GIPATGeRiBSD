...
<sld:StyledLayerDescriptor version="1.0.0"
    ...
    <sld:NamedLayer>
        <sld:Name>pnrlg:pnrlg_canoe</sld:Name>
        <sld:UserStyle>
            <sld:FeatureTypeStyle>
                <sld:Rule>
                    <sld:Name>Classe_3389</sld:Name>
                    <sld:Title>canoe</sld:Title>
                    <sld:PointSymbolizer>
                        <sld:Graphic>
                            <sld:Mark>
                                ...
                                <sld:Stroke>
                                    <sld:CssParameter name="stroke">#339966</sld:CssParameter>
                    ...
                    <sld:TextSymbolizer>
                        <sld:Label>
                            <ogc:PropertyName xmlns:ogc="http://www.opengis.net/ogc">organisme</ogc:PropertyName>
                        </sld:Label>
                        <sld:Font>
