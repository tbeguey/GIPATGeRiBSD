...
<sld:StyledLayerDescriptor version="1.0.0"
    ...
    <sld:NamedLayer>
        <sld:Name>ign:ign_bdtopo_cantons</sld:Name>
        <sld:UserStyle>
            <sld:FeatureTypeStyle>
                <sld:Rule>
                    <sld:Name>Classe_4226</sld:Name>
                    <sld:Title>Sans titre 4226</sld:Title>
                    <sld:PolygonSymbolizer>
                        ...
                        <sld:Stroke>
                            <sld:CssParameter name="stroke">#986432</sld:CssParameter>
