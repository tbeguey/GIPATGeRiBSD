...
<sld:StyledLayerDescriptor version="1.0.0"
    ...
    <sld:NamedLayer>
        <sld:Name>ign:ign_bdtopo_commune</sld:Name>
        <sld:UserStyle>
            <sld:FeatureTypeStyle>
                <sld:Rule>
                    <sld:Name>Classe_4441</sld:Name>
                    <sld:Title>Sans titre 4441</sld:Title>
                    ...
                    <sld:PolygonSymbolizer>
                        ...
                        <sld:Stroke>
                            <sld:CssParameter name="stroke">#FF01FF</sld:CssParameter>
