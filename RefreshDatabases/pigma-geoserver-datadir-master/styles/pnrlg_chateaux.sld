...
<sld:StyledLayerDescriptor version="1.0.0"
    ...
    <sld:NamedLayer>
        <sld:Name>pnrlg:pnrlg_chateaux</sld:Name>
        <sld:UserStyle>
            <sld:FeatureTypeStyle>
                <sld:Rule>
                    <sld:Name>Classe_3389</sld:Name>
                    <sld:Title>chateaux</sld:Title>
                    <sld:PointSymbolizer>
                        <sld:Graphic>
                            <sld:Mark>
                                ...
                                <sld:Stroke>
                                    <sld:CssParameter name="stroke">#C58B04</sld:CssParameter>
                    ...
                    <sld:TextSymbolizer>
                        ...
                        <sld:Fill>
                            <sld:CssParameter name="fill">#B17C00</sld:CssParameter>
                        </sld:Fill>
                    </sld:TextSymbolizer>
                </sld:Rule>
            </sld:FeatureTypeStyle>
