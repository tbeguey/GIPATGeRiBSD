<sld:StyledLayerDescriptor xmlns:sld="http://www.opengis.net/sld" version="1.0.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.0.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml">
  <sld:NamedLayer>
    <sld:Name>ars:ars_maternite</sld:Name>
    <sld:UserStyle>
        ...
        <sld:Rule>
          ...
          <sld:TextSymbolizer>
             <sld:Label>
              <ogc:PropertyName>raison_soc</ogc:PropertyName>
            </sld:Label>
            <sld:Font>
          ...
          <sld:PointSymbolizer>
            <sld:Graphic>
              <sld:Mark>
                ...
                <sld:Fill>
                  <sld:CssParameter name="fill">#4CDBDB</sld:CssParameter>
                  <sld:CssParameter name="fill-opacity">1</sld:CssParameter>
                </sld:Fill>
                <sld:Stroke>
          ...
          <sld:PointSymbolizer>
            <sld:Graphic>
              ...
              <sld:Rotation>0</sld:Rotation>
                ...
                <sld:Rule>
          <sld:Name>Classe_376</sld:Name>
          <sld:Title>ESPIC</sld:Title>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsEqualTo>
                <ogc:PropertyName>statut</ogc:PropertyName>
                <ogc:Literal>ESPIC</ogc:Literal>
              </ogc:PropertyIsEqualTo>
            </ogc:And>
          </ogc:Filter>
          <sld:PointSymbolizer>
