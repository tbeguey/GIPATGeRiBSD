    ...
    <sld:NamedLayer>
        ...
        <sld:UserStyle>
            <sld:FeatureTypeStyle>
                <sld:Rule>
				<sld:MaxScaleDenominator>499999</sld:MaxScaleDenominator>
				<sld:MinScaleDenominator>49000</sld:MinScaleDenominator>
                    <sld:Name>Tissu urbain dense</sld:Name>
                    <sld:Title>Tissu urbain dense</sld:Title>
                    <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
                        <ogc:PropertyIsEqualTo>
                            <ogc:PropertyName>code09niv4</ogc:PropertyName>
				...
				<sld:MinScaleDenominator>49000</sld:MinScaleDenominator>
					...
					<sld:PolygonSymbolizer>
                        <sld:Fill>
                            <sld:CssParameter name="fill">#949400</sld:CssParameter>
                            <sld:CssParameter name="fill-opacity">1</sld:CssParameter>
                        </sld:Fill>
                    </sld:PolygonSymbolizer> 
                </sld:Rule>
